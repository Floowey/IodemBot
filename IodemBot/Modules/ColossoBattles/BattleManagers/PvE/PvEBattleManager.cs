...
{
    public abstract class PvEBattleManager : BattleManager
    {
        ...
        public PvEBattleManager(string Name, ITextChannel lobbyChannel, ITextChannel BattleChannel) : base(Name, lobbyChannel)
        {
