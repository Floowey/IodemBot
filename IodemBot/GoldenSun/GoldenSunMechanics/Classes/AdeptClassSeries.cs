    ...
    public class AdeptClassSeries
    {
        ...
        static AdeptClassSeries()
        {
            DictReq = new Dictionary<string, IRequirement>
            {
                ...
                {"HighestDamage", new HighestDamageRequirement()},
                {"DamageTanked", new DamageTankedRequirement()},
                {"PPUsed", new PPUsedRequirement()},
                ...
                {"ItemActivation", new ItemActivationRequirement()},
